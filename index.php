...
<body>
	<div id="wrap">
		...
		<div id="content">
			<div style="text-align: right"><a href="logout.php" class="bbs-logout">Logout</a></div>
			<form action="" method="post">
				<dl class="bbs-contents">
					<dt class="bbs-text"><?php echo h($name); ?>さん、メッセージをどうぞ</dt>
					<dd>
						<textarea name="message" class="bbs-textarea"></textarea>
					</dd>
				</dl>
				<div>
					<p class="bbs-button-outer">
						<input type="submit" value="post" class="bbs-button"/>
					</p>
				</div>
			</form>
			...
			<div class="msg">
				...
				<p class="day"><a href="view.php?id=<?php echo h($id); ?>"　class="bbs-day"><?php echo h($created); ?></a>
